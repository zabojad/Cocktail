...
import cocktail.core.parser.html.InputStream;
import cocktail.core.parser.html.Tokenizer;
import cocktail.core.parser.html.TreeBuilder;
import cocktail.core.parser.html.Token;
import cocktail.core.parser.html.State;
...
class HTMLParser
{
	 ...
	 */
	static public function parse(data : String) : HTMLDocument
	{
		var dom : DOMImplementation = new DOMImplementation();
		// the document that will result of the HTML parsing
		var doc : HTMLDocument = dom.createHTMLDocument();
